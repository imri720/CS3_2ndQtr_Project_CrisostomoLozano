/* ---------- Mobile nav toggle (used on small screens) ---------- */
/* If you add a hamburger button with id="hambtn" and a nav with id="mainnav",
   the code below will toggle visibility.
*/
...
/* All quiz code is encapsulated under the `ValorantQuiz` namespace to avoid
   polluting the global scope. The mini-game page calls ValorantQuiz.init()
   to populate the question and wire up buttons.
*/
